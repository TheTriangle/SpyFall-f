...
public class Rotater {
    ...
    private static TCPClient.IOnMsgRecv reciever = new TCPClient.IOnMsgRecv() {
        ...
        public void msgRecv(JSONObject msg) {
            try {
                String key = msg.getString("method");
                methods.get(key).handle(msg);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private static HashMap<String, methodHandler> methods = new HashMap<String, methodHandler>();
